...
== Migratio to V1 (switch from AsyncApi v2.6.0 to v3.0.0)
Configuration:
* Server.url is divided into server.url and server.pathname (see https://www.asyncapi.com/docs/migration/migrating-to-v3#server-url-splitting-up)
